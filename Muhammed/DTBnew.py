...
class Game:
    ...
    def update(self):
        ...
        #if self.turn == 6:
            #update_db(self.turn,"Game_1")
            #update_db(self.turn,"Game_2")
            #program_victory()
    ...
    def game_loop(self):
        ...
        while not process_events():
            ...
            if self.turn_player == "player1":
                ...
                self.player2_turn()
            if True:#self.Player1.Furgo.hp == 0 and self.Player1.Intensity.hp == 0 and self.Player1.Silver.hp == 0 and self.Player1.Merapi.hp == 0 or self.Player2.Furgo.hp == 0 and self.Player2.Intensity.hp == 0 and self.Player2.Silver.hp == 0 and self.Player2.Merapi.hp == 0:
