...
#kaaart -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        if press[0] == 1:
                ...
                if pos[0] >= 130 and pos[0] <= 170 and pos[1] >= 250 and pos[1] <= 360 or self.column == self.Player1.Furgo.pos_column and self.row == self.Player1.Furgo.pos_row +2:
                    self.boat = "DrieGroen"
                ...
                elif pos[0] >= 130 and pos[0] <= 170 and pos[1] >= 650 and pos[1] <= 760 or self.column == self.Player2.Furgo.pos_column and self.row == self.Player2.Furgo.pos_row:
                    self.boat = "DrieGeel"
    ...
    def draw(self):
        global color, color1, color2, color3, color4, color5, color6, color7, bright_green, color9, green2, YELLOW2
        self.BLACK = (0, 0, 0)
        self.WHITE = (255, 255, 255)
        self.GREEN = (0, 255, 0)
        self.RED = (255, 0, 0)
        ...
        #kaarten    && kaart buttons  ______________________________________________________________________________________________________________________________________________________________________
        #   select cards buttons
        #   normal cards
        #   player 1 - 2 start kaarten - kleur is groen
